...
const StartupForm = () => {
    ...
    const handleFormSubmit = async (prevState:any,formData:FormData)=> {
        try{
            ...
            if(result.status==='SUCCESS')
            {
                toast({
                    title:'Success',
                    description:"Your startup hsa been created successfully.",
                })
            ...
            return {
                ...prevState,error:'Unexpected Error occurred',status:'ERROR'
            }
        }
    ...
    return <form action={formAction} className="startup-form">
        ...
        <div>
            <label htmlFor="categpry" className="startup-form_label">Category</label>
        ...
        <div>
            ...
            <Input id="link" name="link" className="startup-form_textarea" required placeholder="Startup Image URL"/>
            {errors.link && <p className="startup-form_error">{errors.link}</p>}
        </div>

        <div data-color-mode="light">
            <label htmlFor="iitch" className="startup-form_label">Pitch</label>
            <MDEditor
                value={pitch}
